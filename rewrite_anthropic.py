...
replacements = [
    ...
    (r'func performToolSearch\(w http\.ResponseWriter, acc \*Account',
     r'func performToolSearch(r *http.Request, w http.ResponseWriter, acc *Account')
]
...
# performToolSearch call
content = re.sub(r'performToolSearch\(w, acc, flusher, blockIndex, toolQuery, requestID, outputConfig\)',
                 r'performToolSearch(r, w, acc, flusher, blockIndex, toolQuery, requestID, outputConfig)', content)
